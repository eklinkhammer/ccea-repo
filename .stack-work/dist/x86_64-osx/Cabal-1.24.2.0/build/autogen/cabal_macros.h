...
/* package rover-domain-0.1.0.0 */
#define VERSION_rover_domain "0.1.0.0"
#define MIN_VERSION_rover_domain(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "rover-domain-0.1.0.0-61Fsc9uUajFGfxZsLCyosq"

#define CURRENT_PACKAGE_KEY "rover-domain-0.1.0.0-61Fsc9uUajFGfxZsLCyosq"
